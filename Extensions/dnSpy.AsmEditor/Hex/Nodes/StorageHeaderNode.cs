...
sealed class StorageHeaderNode : HexNode
{
    ...
    public StorageHeaderNode(StorageHeaderVM storageHeader, IDocumentTreeNodeDataContext context)
        : base(storageHeader.Span, context) => storageHeaderVM = storageHeader;
