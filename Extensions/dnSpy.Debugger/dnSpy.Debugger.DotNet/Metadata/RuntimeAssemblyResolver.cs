...
public sealed class RuntimeAssemblyResolver : IRuntimeAssemblyResolver, IDbgManagerStartListener
{
    ...
    RuntimeAssemblyResolverResult IRuntimeAssemblyResolver.Resolve(IAssembly assembly, ModuleDef? sourceModule)
    {
        ...
        foreach (var runtime in GetRuntimes(dbgManager, assembly, sourceModule?.Location))
        {
            ...
            var asmName = new DmdReadOnlyAssemblyName(assembly.Name, assembly.Version, assembly.Culture, (DmdAssemblyNameFlags)assembly.Attributes,
                assembly.PublicKeyOrToken?.Data, GetAssemblyHashAlgorithm(assembly));
