...
namespace dnSpy.Themes
{
    ...
    {
        static readonly Dictionary<string, ColorType> nameToColorType = new(StringComparer.InvariantCultureIgnoreCase);
        ...
        static ColorType ToColorType(int i)
        {
            ...
            if ((int)(ColorType.LastNR - ColorType.FirstNR) <= i &&
                i < (int)((ColorType.LastNR - ColorType.FirstNR) + (ColorType.LastUI - ColorType.FirstUI)))
