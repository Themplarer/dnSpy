...
using dnSpy.Disassembly;
using dnSpy.Disassembly.Viewer;

namespace MyApp.Disassembly.Viewer;
...
sealed class DisassemblyAppSettingsPage : AppSettingsPage {
	...
	public override Guid Guid => new(AppSettingsConstants.GUID_DISASSEMBLER);

	public override string Title => "dnSpy_Resources.DisassemblerDlgTabTitle;"; // TODO
