...
{
    public PEDocumentNodeImpl(IDsDocument document, IDocumentTreeNodeDataContext context)
        : base(document, context) => Debug2.Assert(document.PEImage is not null && document.ModuleDef is null);
