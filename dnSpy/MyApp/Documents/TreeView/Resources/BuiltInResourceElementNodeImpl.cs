...
{
    public override Guid Guid => new(DocumentTreeViewConstants.BUILT_IN_RESOURCE_ELEMENT_NODE_GUID);
    ...
    protected override ImageReference GetIcon()
    {
        ...
        if (ResourceElement.ResourceData.Code >= ResourceTypeCode.UserTypes)
