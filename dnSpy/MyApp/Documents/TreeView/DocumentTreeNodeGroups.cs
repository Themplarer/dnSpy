...
sealed class DocumentTreeNodeGroups : IDocumentTreeNodeGroups
{
    public ITreeNodeGroup GetGroup(DocumentTreeNodeGroupType type)
    {
        switch (type)
        {
            ...
            case DocumentTreeNodeGroupType.MethodReferencesFolderTreeNodeGroupTypeReference:
                return MethodReferencesFolderTreeNodeGroupTypeReference;
            ...
            case DocumentTreeNodeGroupType.PropertyReferencesFolderTreeNodeGroupTypeReference:
                return PropertyReferencesFolderTreeNodeGroupTypeReference;
            ...
            case DocumentTreeNodeGroupType.MethodReferenceTreeNodeGroupMethodReferencesFolder:
                return MethodReferenceTreeNodeGroupMethodReferencesFolder;
            case DocumentTreeNodeGroupType.FieldReferenceTreeNodeGroupFieldReferencesFolder:
                return FieldReferenceTreeNodeGroupFieldReferencesFolder;
            case DocumentTreeNodeGroupType.PropertyReferenceTreeNodeGroupPropertyReferencesFolder:
                return PropertyReferenceTreeNodeGroupPropertyReferencesFolder;
            case DocumentTreeNodeGroupType.EventReferenceTreeNodeGroupEventReferencesFolder:
                return EventReferenceTreeNodeGroupEventReferencesFolder;
            default: throw new ArgumentException();
        }
    }

    readonly ITreeNodeGroup2 AssemblyRefTreeNodeGroupReferences =
        new AssemblyRefTreeNodeGroup(DocumentTreeViewConstants.ORDER_REFERENCES_ASSEMBLYREF);

    readonly ITreeNodeGroup2 AssemblyRefTreeNodeGroupAssemblyRef =
        new AssemblyRefTreeNodeGroup(DocumentTreeViewConstants.ORDER_ASSEMBLYREF_ASSEMBLYREF);
    ...
    readonly ITreeNodeGroup2 ReferencesFolderTreeNodeGroupModule =
        new ReferencesFolderTreeNodeGroup(DocumentTreeViewConstants.ORDER_MODULE_REFERENCES_FOLDER);

    readonly ITreeNodeGroup2 ResourcesFolderTreeNodeGroupModule =
        new ResourcesFolderTreeNodeGroup(DocumentTreeViewConstants.ORDER_MODULE_RESOURCES_FOLDER);
    ...
    readonly ITreeNodeGroup2 InterfaceBaseTypeTreeNodeGroupBaseType =
        new BaseTypeTreeNodeGroup(DocumentTreeViewConstants.ORDER_BASETYPEFOLDER_INTERFACE);

    readonly ITreeNodeGroup2 DerivedTypesFolderTreeNodeGroupType =
        new DerivedTypesFolderTreeNodeGroup(DocumentTreeViewConstants.ORDER_TYPE_DERIVED);
    ...
    readonly ITreeNodeGroup2 TypeReferenceTreeNodeGroupTypeReferences =
        new TypeReferenceTreeNodeGroup(DocumentTreeViewConstants.ORDER_TYPEREFS_TYPEREF);

    readonly ITreeNodeGroup2 TypeSpecsFolderTreeNodeGroupTypeReference =
        new TypeSpecsFolderTreeNodeGroup(DocumentTreeViewConstants.ORDER_TYPEREF_TYPESPECFOLDER);

    readonly ITreeNodeGroup2 MethodReferencesFolderTreeNodeGroupTypeReference =
        new MethodReferencesFolderTreeNodeGroup(DocumentTreeViewConstants.ORDER_TYPEREF_METHODREFFOLDER);

    readonly ITreeNodeGroup2 PropertyReferencesFolderTreeNodeGroupTypeReference =
        new PropertyReferencesFolderTreeNodeGroup(DocumentTreeViewConstants.ORDER_TYPEREF_PROPERTYREFFOLDER);

    readonly ITreeNodeGroup2 EventReferencesFolderTreeNodeGroupTypeReference =
        new EventReferencesFolderTreeNodeGroup(DocumentTreeViewConstants.ORDER_TYPEREF_EVENTREFFOLDER);

    readonly ITreeNodeGroup2 FieldReferencesFolderTreeNodeGroupTypeReference =
        new FieldReferencesFolderTreeNodeGroup(DocumentTreeViewConstants.ORDER_TYPEREF_FIELDREFFOLDER);

    readonly ITreeNodeGroup2 TypeSpecTreeNodeGroupTypeSpecsFolder =
        new TypeReferenceTreeNodeGroup(DocumentTreeViewConstants.ORDER_TYPESPECS_TYPESPEC);

    readonly ITreeNodeGroup2 MethodReferenceTreeNodeGroupMethodReferencesFolder =
        new MethodReferenceTreeNodeGroup(DocumentTreeViewConstants.ORDER_METHODREFS_METHODREF);

    readonly ITreeNodeGroup2 PropertyReferenceTreeNodeGroupPropertyReferencesFolder =
        new PropertyReferenceTreeNodeGroup(DocumentTreeViewConstants.ORDER_EVENTREFS_EVENTREF);

    readonly ITreeNodeGroup2 EventReferenceTreeNodeGroupEventReferencesFolder =
        new EventReferenceTreeNodeGroup(DocumentTreeViewConstants.ORDER_FIELDREFS_FIELDREF);

    readonly ITreeNodeGroup2 FieldReferenceTreeNodeGroupFieldReferencesFolder =
        new FieldReferenceTreeNodeGroup(DocumentTreeViewConstants.ORDER_FIELDREFS_FIELDREF);
