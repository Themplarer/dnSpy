...
sealed class PropertyNodeImpl : PropertyNode
{
    ...
    public PropertyNodeImpl(ITreeNodeGroup treeNodeGroup, PropertyDef property, IDocumentTreeNodeDataContext context)
        : base(property, context) => TreeNodeGroup = treeNodeGroup;
    ...
    public override IEnumerable<TreeNodeData> CreateChildren()
    {
        foreach (var m in PropertyDef.GetMethods)
            yield return new MethodNodeImpl(
                Context.DocumentTreeView.DocumentTreeNodeGroups.GetGroup(DocumentTreeNodeGroupType.MethodTreeNodeGroupProperty), m, Context);
