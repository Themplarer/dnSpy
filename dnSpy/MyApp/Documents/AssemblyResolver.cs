...
sealed class AssemblyResolver : IAssemblyResolver
{
    ...
    static readonly UTF8String mscorlibName = new("mscorlib");
    static readonly UTF8String systemRuntimeName = new("System.Runtime");
    static readonly UTF8String netstandardName = new("netstandard");

    static readonly UTF8String aspNetCoreName = new("Microsoft.AspNetCore");

    // netstandard1.5 also uses this version number, but assume it's .NET
    static readonly Version minSystemRuntimeNetCoreVersion = new(4, 1, 0, 0);
    ...
    public AssemblyResolver(DsDocumentService documentService,
        Lazy<IRuntimeAssemblyResolver, IRuntimeAssemblyResolverMetadata>[] runtimeAsmResolvers)
    {
    ...
    sealed class FailedAssemblyResolveCache
    {
        ...
        readonly HashSet<IAssembly> failedAsms = new(AssemblyNameComparer.CompareAll);
        ...
        public bool IsFailed(IAssembly asm)
        {
            ...
            lock (lockObj)
            {
                ...
                var isOld = (now - lastTime).TotalSeconds > MAX_CACHE_TIME_SECONDS;
    ...
    IDsDocument? TryRuntimeAssemblyResolvers(IAssembly assembly, ModuleDef? sourceModule)
    {
        foreach (var lz in runtimeAsmResolvers)
        {
            ...
            if (!result.IsDefault)
            {
                ...
                {
                    var file = documentService.Find(new FilenameKey(result.Filename), checkTempCache: true);
                    if (file is not null)
                        return file;
                }
    ...
    static readonly Version version_4_1_0_0 = new(4, 1, 0, 0);
    static readonly Version version_4_2_0_0 = new(4, 2, 0, 0);
    static readonly Version version_4_2_1_0 = new(4, 2, 1, 0);
    static readonly Version version_4_2_2_0 = new(4, 2, 2, 0);
    static readonly Version version_5_0_0_0 = new(5, 0, 0, 0);
    static readonly Version version_6_0_0_0 = new(6, 0, 0, 0);
    ...
    (IDsDocument? document, bool loaded) LookupFromSearchPaths(IAssembly asmName, ModuleDef? sourceModule, string? sourceModuleDir,
        Version? dotNetCoreAppVersion)
    {
        IDsDocument? document;
    ...
    IDsDocument? TryFindFromDir(IAssembly asmName, string dirPath)
    {
        ...
        {
            // eg. invalid chars in asmName.Name
            return null;
        }
    ...
    IDsDocument? TryFindFromDir2(string filename) => documentService.Find(new FilenameKey(filename), checkTempCache: true);
    ...
    {
        if ((TryRuntimeAssemblyResolvers(assembly, sourceModule) ?? documentService.FindAssembly(assembly, DsDocumentService.DefaultOptions)) is
            { } document)
            return document;
