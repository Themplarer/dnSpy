...
using AssemblyResolver = MyApp.Documents.AssemblyResolver;
...
sealed class DsDocumentService : IDsDocumentService
{
    ...
    public DsDocumentService(IDsDocumentServiceSettings documentServiceSettings, IEnumerable<IDsDocumentProvider> documentProviders,
        IEnumerable<Lazy<IRuntimeAssemblyResolver, IRuntimeAssemblyResolverMetadata>> runtimeAsmResolvers)
    {
